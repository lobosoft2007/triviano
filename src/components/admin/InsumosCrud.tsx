  ...
  return (
    <section>
      ...
      <div className="mb-4">
        <div className="relative">
          <Input
            ...
            placeholder="Buscar por nome do insumo ou parte dele...pode ordenar colunas depois de filtrar..."
      ...
      {isLoading ? (
        ...
        <div className="overflow-x-auto overflow-y-auto overscroll-contain max-h-[calc(100vh-280px)] rounded-2xl border border-border bg-card">
          <table className="w-full min-w-[640px] text-sm">
            <thead className="sticky top-0 z-10 bg-card text-left text-xs uppercase tracking-wide text-muted-foreground shadow-sm">
              <tr>
                ...
                <th className="px-4 py-2.5 font-semibold" title="Unidade de consumo">
                  Un.
                </th>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent hideClose className="max-w-lg">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <Field label={`Estoque mínimo em ${form.unidade_estoque ? `${form.unidade_estoque}` : ""}`}>
              <Input
                inputMode="decimal"
