...
BEGIN
  IF public.is_master_admin() THEN
    RETURN QUERY SELECT true, false, true, true, true, true, true, true, true, true, true, true, true, true;
    RETURN;
  END IF;
  ...
  IF NOT FOUND THEN
    RETURN QUERY SELECT false, true, false, false, false, false, false, false, false, false, false, false, false, false;
  END IF;
END;
$function$;